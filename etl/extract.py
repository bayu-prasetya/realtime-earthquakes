...
Module to fetch and parse earthquake data from the USGS Earthquake API.
Supports both real-time (past hour/day) and historical queries.

Author: Nayu Dwi Prasetya
Created: [2025-07-06]

API references:
- Feed API (real-time): https://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php
- Query API (historical): https://earthquake.usgs.gov/fdsnws/event/1/
